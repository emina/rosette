...
; Returns two values: the list of assumptions and the list of assertions
; generated by evaluating the given thunk.  If the evaluation of the thunk
; results in an exn:fail? exception, the assertions list will contain
; the value #f.
(define (vcs closure)
