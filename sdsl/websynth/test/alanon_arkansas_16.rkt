...
(define-symbolic r4f1zpath tag? [max_zpath_depth])
(define-symbolic r4f2zpath tag? [max_zpath_depth])

(define-symbolic r4fieldmask boolean? [max_zpath_depth])
; Record 5 fields
(define-symbolic r5f0zpath tag? [max_zpath_depth])
(define-symbolic r5f1zpath tag? [max_zpath_depth])
(define-symbolic r5f2zpath tag? [max_zpath_depth])

(define-symbolic r5fieldmask boolean? [max_zpath_depth])
; Record 6 fields
(define-symbolic r6f0zpath tag? [max_zpath_depth])
(define-symbolic r6f1zpath tag? [max_zpath_depth])
(define-symbolic r6f2zpath tag? [max_zpath_depth])

(define-symbolic r6fieldmask boolean? [max_zpath_depth])
; Record 7 fields
(define-symbolic r7f0zpath tag? [max_zpath_depth])
(define-symbolic r7f1zpath tag? [max_zpath_depth])
(define-symbolic r7f2zpath tag? [max_zpath_depth])

(define-symbolic r7fieldmask boolean? [max_zpath_depth])
; Record 8 fields
(define-symbolic r8f0zpath tag? [max_zpath_depth])
(define-symbolic r8f1zpath tag? [max_zpath_depth])
(define-symbolic r8f2zpath tag? [max_zpath_depth])

(define-symbolic r8fieldmask boolean? [max_zpath_depth])
; Record 9 fields
(define-symbolic r9f0zpath tag? [max_zpath_depth])
(define-symbolic r9f1zpath tag? [max_zpath_depth])
(define-symbolic r9f2zpath tag? [max_zpath_depth])

(define-symbolic r9fieldmask boolean? [max_zpath_depth])
; Record 10 fields
(define-symbolic r10f0zpath tag? [max_zpath_depth])
(define-symbolic r10f1zpath tag? [max_zpath_depth])
(define-symbolic r10f2zpath tag? [max_zpath_depth])

(define-symbolic r10fieldmask boolean? [max_zpath_depth])
; Record 11 fields
(define-symbolic r11f0zpath tag? [max_zpath_depth])
(define-symbolic r11f1zpath tag? [max_zpath_depth])
(define-symbolic r11f2zpath tag? [max_zpath_depth])

(define-symbolic r11fieldmask boolean? [max_zpath_depth])
; Record 12 fields
(define-symbolic r12f0zpath tag? [max_zpath_depth])
(define-symbolic r12f1zpath tag? [max_zpath_depth])
(define-symbolic r12f2zpath tag? [max_zpath_depth])

(define-symbolic r12fieldmask boolean? [max_zpath_depth])
; Record 13 fields
(define-symbolic r13f0zpath tag? [max_zpath_depth])
(define-symbolic r13f1zpath tag? [max_zpath_depth])
(define-symbolic r13f2zpath tag? [max_zpath_depth])

(define-symbolic r13fieldmask boolean? [max_zpath_depth])
; Record 14 fields
(define-symbolic r14f0zpath tag? [max_zpath_depth])
(define-symbolic r14f1zpath tag? [max_zpath_depth])
(define-symbolic r14f2zpath tag? [max_zpath_depth])

(define-symbolic r14fieldmask boolean? [max_zpath_depth])
; Record 15 fields
(define-symbolic r15f0zpath tag? [max_zpath_depth])
(define-symbolic r15f1zpath tag? [max_zpath_depth])
(define-symbolic r15f2zpath tag? [max_zpath_depth])
