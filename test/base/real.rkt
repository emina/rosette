...
(define (check-integer->real-semantics)
  ...
  (check-state (@integer->real 1) 1.0 (list))
  ...
  (check-state (@integer->real (merge a 1 'a)) 1.0 (list a))
...
(define (check-real->integer-semantics) 
  ...
  (check-state (@real->integer 5.0) 5 (list))
  ...
  (check-state (@real->integer (merge a 1 yr)) (@real->integer (merge a 1.0 yr)) (list))
